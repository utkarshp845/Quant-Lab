...
app/api/market_data_stream.py), and (v0.1.17) persisted storage for
fetched historical bars (a local SQLite file, app/storage/) layered on
top -- no brokerage connectivity, no trade execution, no auth. See the
README for the full list of assumptions and what is intentionally not
implemented yet.
"""
